...
**The terminal state is creating an implementation plan.** Do NOT jump into implementation. The next step after brainstorming is writing the plan.
...
- Create a detailed implementation plan (see the writing-plans skill).
- Do NOT jump straight into code. Writing the plan is the next step.
