defmodule SymphonyElixirWeb.RecentsChannel do
  @moduledoc "Global recents channel: pushes recent-item snapshots to tracker clients."
  ...
  @impl true
  def join("recents", _payload, socket) do
  ...
  def handle_info({:recents_event, event, payload}, socket) do
