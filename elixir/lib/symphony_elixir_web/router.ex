defmodule SymphonyElixirWeb.Router do
  ...
  scope "/api/tracker/v1", SymphonyElixirWeb.Tracker do
    ...
    post("/mobile_push/subscriptions", MobilePushController, :create)
    delete("/mobile_push/subscriptions", MobilePushController, :delete)
    post("/mobile_push/test", MobilePushController, :test)
    post("/mobile_rpc/pairing_offer", MobileRpcController, :create_pairing_offer)
    get("/mobile_rpc/devices", MobileRpcController, :devices)
    delete("/mobile_rpc/devices/:device_id", MobileRpcController, :revoke_device)
