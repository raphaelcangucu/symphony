defmodule SymphonyElixirWeb.Router do
  ...
  scope "/api/tracker/v1", SymphonyElixirWeb.Tracker do
    ...
    put("/settings/agents/:agent/source", AgentLifecycleController, :source)
    post("/settings/agents/:agent/install", AgentLifecycleController, :install)
    post("/settings/agents/:agent/update", AgentLifecycleController, :update)
    post("/settings/agents/:agent/repair", AgentLifecycleController, :repair)
    get("/settings/agents/:agent/accounts", AgentLifecycleController, :accounts)
    post("/settings/agents/:agent/accounts", AgentLifecycleController, :create_account)
    put("/settings/agents/:agent/accounts/:id", AgentLifecycleController, :update_account)
    ...
    post("/assistant/threads/:thread_id/evidence", EvidenceController, :create_for_thread)
