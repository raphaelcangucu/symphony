...
/** Shared scrim styling for every modal surface (Dialog, Sheet, Command, custom overlays). */
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay ref={ref} className={cn(OVERLAY_CLASS, className)} {...props} />
));
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-1/2 top-1/2 z-50 grid w-[calc(100%-2rem)] max-w-lg -translate-x-1/2 -translate-y-1/2 gap-4 overflow-x-hidden rounded-lg border bg-background p-6 shadow-lg [&>*]:min-w-0",
        className,
      )}
      {...props}
    >
